	...
	if( NOT "${TYPE}" STREQUAL "" )
		...
		if( WIN32 )
			...
			if( NOT "${TYPE}" STREQUAL "COMPUTE" )
				set( DX9_OUTPUT ${BIG_ROOT}/examples/runtime/shaders/dx9/${FILENAME}.bin )
			...
			# dx11
			set( DX11_OUTPUT ${BIG_ROOT}/examples/runtime/shaders/dx11/${FILENAME}.bin )
			if( NOT "${TYPE}" STREQUAL "COMPUTE" )
		...
		if( APPLE )
			# metal
			set( METAL_OUTPUT ${BIG_ROOT}/examples/runtime/shaders/metal/${FILENAME}.bin )
		...
		# essl
		if( NOT "${TYPE}" STREQUAL "COMPUTE" )
			set( ESSL_OUTPUT ${BIG_ROOT}/examples/runtime/shaders/essl/${FILENAME}.bin )
		...
		# glsl
		set( GLSL_OUTPUT ${BIG_ROOT}/examples/runtime/shaders/glsl/${FILENAME}.bin )
		if( NOT "${TYPE}" STREQUAL "COMPUTE" )
		...
		# spirv
		if( NOT "${TYPE}" STREQUAL "COMPUTE" )
			set( SPIRV_OUTPUT ${BIG_ROOT}/examples/runtime/shaders/spirv/${FILENAME}.bin )
